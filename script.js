...
sr.reveal('.about, .services-list , .about-strangers', { delay: 200 });
sr.reveal('.Events, .title, .card__article', { delay: 400 });
sr.reveal('.prv-projects, .projects , .project-item', { interval: 200 });
sr.reveal('.footer , .footer-content, .container , .card', { interval: 200 });
